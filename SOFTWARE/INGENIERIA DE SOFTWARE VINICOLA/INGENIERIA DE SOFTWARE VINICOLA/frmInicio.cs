...
namespace INGENIERIA_DE_SOFTWARE_VINICOLA
{
    ...
    {
       public GestionDeFamilias formGestionFamilias = new GestionDeFamilias();
       ...
       public GestionDePerfiles FormGestionDePerfiles = new GestionDePerfiles();
       public Eventos formEventos = new Eventos();  
       ...
       public Factura fact = new Factura();
        ...
        private void modificarMenu() 
        {
            ...
            bitacoraDeEventosToolStripMenuItem.Visible = false;
