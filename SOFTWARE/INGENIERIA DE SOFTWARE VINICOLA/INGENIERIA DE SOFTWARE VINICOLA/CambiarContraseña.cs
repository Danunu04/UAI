...
namespace INGENIERIA_DE_SOFTWARE_VINICOLA
{
    public partial class CambiarContraseña : Form, IObserver
    {
        ...
        Usuario _user = SessionManager.ObtenerDatosUsuario();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox2.Text != "" || textBox3.Text != "" || textBox4.Text != "")
            {
                if (_user != null)
                {
                    if (cryptoManager.GetSHA256(textBox2.Text) == _user.Password)
                    {
                        if (textBox3.Text == textBox4.Text)
                        {
                            try
                            {
                                ...
                                NegociosUsuario.ActualizarContraseña(_user.DNI, cryptoManager.GetSHA256(textBox3.Text));
